...
export default function LetterModal({ isOpen, onClose }: LetterModalProps) {
  ...
  return (
    ...
    >
      ...
      <div
        className={`relative z-10 bg-[#FAF8F2] rounded-lg w-[90%] max-w-xl lg:max-w-2xl xl:max-w-2xl max-h-[82vh] md:my-0 overflow-y-auto md:pt-18 md:pb-12 md:px-16 px-8 py-14 
