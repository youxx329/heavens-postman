  ...
  return (
    <div className="relative h-full font-letter text-[#4A3F35] will-change-transform transform-gpu">
      {step === 'writing' && (
        <div key="writing" className="animate-fade-in space-y-6 flex flex-col">
          ...
          <textarea
            ...
            rows={7}
            className="w-full overflow-hidden resize-none bg-transparent py-2 placeholder:text-[#4A3F35]/40 focus:outline-none md:text-[20px] text-[18px] italic"
            style={{
          ...
          {error && <p className="md:text-[16px] text-[14px] text-red-400 text-center">{error}</p>}

          <div className="flex justify-center">
            <button
              onClick={handleProceedToEmail}
              className="cursor-pointer font-letter md:text-[16px] text-[14px] tracking-[0.04em] text-[#FBF6ED] md:px-[54px] md:py-[15px] px-[40px] py-[11px] rounded-full shadow-[0_8px_20px_rgba(216,140,90,0.32)] hover:shadow-[0_10px_24px_rgba(216,140,90,0.42)] hover:-translate-y-px transition-[transform,box-shadow] duration-300 ease-out flex justify-center items-center font-bold"
              style={{
      ...
      {step === 'email' && (
        ...
        >
          <p className="text-center text-[#4A3F35] md:text-lg text-[16px] break-keep">
          ...
          {error && (
            <p className="text-center md:text-[16px] text-[14px] text-red-400 break-keep">
              {error}
            </p>
          )}
      ...
      {step === 'confirm' && (
        ...
        >
          ...
          <p className="text-center text-[#4A3F35] md:text-xl text-lg font-bold break-all">
            {formData.senderEmail}
          </p>
          <p className="text-center text-[#4A3F35]/60 md:text-[16px] text-[14px] break-keep italic">
          ...
          <div className="flex justify-center gap-4 pt-2 md:flex-row flex-col">
            <button
              onClick={handleBackToEmail}
              className="cursor-pointer font-letter md:text-[16px] text-[14px] tracking-[0.04em] text-[#3A2F26] md:px-[54px] md:py-[15px] px-[40px] py-[11px] rounded-full shadow-[0_8px_20px_rgba(216,140,90,0.22)] hover:shadow-[0_10px_24px_rgba(216,140,90,0.32)] hover:-translate-y-px transition-[transform,box-shadow] duration-300 ease-out flex justify-center items-center font-bold"
              style={{
      ...
      {step === 'done' && (
        <div key="done" className="animate-fade-in space-y-4 text-center">
          <p className="text-[#4A3F35] md:text-lg text-[16px] break-keep">
            당신의 편지가 하늘로 전달되었습니다.
          </p>
          <p className="text-[#4A3F35] md:text-lg text-[16px] break-keep">
            약 10분 후, 당신의 메일함으로 전해드릴게요.
          </p>
          <div className="flex justify-center items-center md:gap-4 gap-0 pt-2 md:flex-row flex-col">
            <button
